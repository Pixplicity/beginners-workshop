...
public class CustomAdapterActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        // TODO Complete the `onListItemClick` method. Use the `position` to retrieve an `Animal` object from the `mCustomerAdapter` field and use the `animal.infoUrl` information to create a valid `Uri`
        Uri uri = null;
